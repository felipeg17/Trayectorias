%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Calcula polinomio de quinto orden de interpolaci?n en el espacio articular
% Entradas:
% q0 = initial position
% qf = final position
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function profiles = quintic_p(q,dq,d2q,t)
q0 = q(1); 
q1 = q(2); 
v0 = dq(1); 
v1 = dq(2); 
...
profiles = [a(1)   a(2)    a(3)    a(4)    a(5)   a(6);
            a(2)   2*a(3)  3*a(4)  4*a(5)  5*a(6) 0;
            2*a(3) 6*a(4)  12*a(5) 20*a(6) 0      0;
            6*a(4) 24*a(5) 60*a(6) 0       0      0];